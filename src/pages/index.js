...
import profilePic from "../../public/images/profile/mig.png";

export default function Home() {
  return (
    <>
      <Head>
        <title>Daud Mir Portfolio</title>
        <meta
          name="description"
          content="Daud Mir Portfolio"
        />
      </Head>
      ...
      >
        <Layout className="!pt-24 md:!pt-16 sm:!pt-28">
          <div className="flex w-full items-start justify-between md:flex-col pt-10 pb-24">
            <div className="w-1/2 lg:hidden md:flex flex self-center max-h-fit mb-5">
              {
                <Image
                  priority={true}
                  src={profilePic}
            ...
            <div className="flex w-1/2 flex-col items-center self-center lg:w-full lg:text-center">
              ...
              As a frontend developer, I create high-quality websites that are functional, user-friendly, and visually appealing. 
              I stay ahead of the curve by exploring new technologies and design trends, continuously improving my craft. 
              My work aims to provide meaningful experiences that bring value to businesses and connect with users.
              </p>
